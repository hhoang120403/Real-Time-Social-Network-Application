...
class FollowerService {
    ...
    const followees: IFollowerData[] = await FollowerModel.aggregate([
      ...
      },
      {
        $addFields: {
          ...
          bgImageVersion: '$followeeId.bgImageVersion',
          bgImageId: '$followeeId.bgImageId',
    ...
    const followers: IFollowerData[] = await FollowerModel.aggregate([
      ...
      },
      {
        $addFields: {
          ...
          bgImageVersion: '$followerId.bgImageVersion',
          bgImageId: '$followerId.bgImageId',
  ...
  public async getFolloweesIds(userId: string): Promise<string[]> {
    ...
    return map(followees, (item) => item.followeeId.toString());
  }
}
