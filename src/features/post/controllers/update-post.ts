...
export class UpdatePostController {
  ...
  public async update(req: Request, res: Response): Promise<void> {
    ...
    await UpdatePostController.prototype.handleUpdatePostWithImage(req);
  ...
  public async updatePostWithImage(req: Request, res: Response): Promise<void> {
    ...
    if (imgId && imgVersion) {
      ...
      const result: UploadApiResponse =
        await UpdatePostController.prototype.addImageToExistingPost(req);
      if (!result.public_id) {
  ...
  private async handleUpdatePostWithImage(req: Request): Promise<void> {
    const {
      post,
      bgColor,
      feelings,
  ...
  private async addImageToExistingPost(
    ...
    const { post, bgColor, feelings, privacy, gifUrl, image, profilePicture } =
      req.body;
    const { postId } = req.params;
