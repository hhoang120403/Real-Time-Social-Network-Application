...
describe('EditBasicInfo', () => {
  ...
  describe('info', () => {
    it('should call updateSingleUserItemInCache', async () => {
      ...
      await UpdateBasicInfoController.prototype.updateBasicInfo(req, res);
    ...
    it('should call updateBasicInfoInDB', async () => {
      ...
      await UpdateBasicInfoController.prototype.updateBasicInfo(req, res);
      expect(userQueue.addUserJob).toHaveBeenCalledWith('updateUserInfoInDB', {
  ...
  describe('social', () => {
    it('should call updateSingleUserItemInCache', async () => {
      ...
      await UpdateBasicInfoController.prototype.updateSocialLinks(req, res);
      expect(
        UserCache.prototype.updateSingleUserItemInCache,
      ).toHaveBeenCalledWith(`${req.currentUser?.userId}`, 'social', req.body);
      expect(res.status).toHaveBeenCalledWith(200);
      expect(res.json).toHaveBeenCalledWith({
        message: 'Updated user social links successfully',
      });
    });
