...
describe('Add', () => {
  ...
  describe('profileImage', () => {
    it('should call image upload method', async () => {
      ...
      await AddImageController.prototype.addProfileImage(req, res);
    ...
    it('should call updateSingleUserItemInCache method', async () => {
      ...
      const url =
        'https://res.cloudinary.com/dgneeqwxw/image/upload/v1234/123456';
  ...
  describe('backgroundImage', () => {
    it('should upload new image', async () => {
      ...
      await AddImageController.prototype.addBackgroundImage(req, res);
    ...
    it('should return bad request error', async () => {
      ...
      AddImageController.prototype
        .addBackgroundImage(req, res)
